...
/**
 * This class contains sort methods which are implemented using Multiprocessing Merge Sort.
 *
 ...
 * It is not guaranteed multiprocessing works as expected, it depends on JVM.</p>
 * 
 ...
 * 	</tr>
 * 	<tr>
 * 	 <td style = "border: 1px solid black; text-align: center; padding: 15px;">&#937;(n logn / no. of processors)</td>
 * 	 <td style = "border: 1px solid black; text-align: center; padding: 15px;">&#952;(n logn / no. of processors)</td>
 * 	 <td style = "border: 1px solid black; text-align: center; padding: 15px;">O(n logn / no. of processors)</td>
 ...
 * @version 1.0
 */
public class MergeSort_Multiprocessing 
{
	// Suppresses default constructor, ensuring non-instantiability.
	private MergeSort_Multiprocessing() {}
	
	//no. of logical processors
	private final static int processorsCount = Runtime.getRuntime().availableProcessors();
	
	//use multiprocessing only if size od array is greater than threshold
